...
int main() {
    ...
    // Objects
    Shader whiteShader("shader/obj_vert.glsl", "shader/white_frag.glsl");
    Shader redShader("shader/obj_vert.glsl", "shader/red_frag.glsl");
    Shader greenShader("shader/obj_vert.glsl", "shader/green_frag.glsl");
    Shader blueShader("shader/obj_vert.glsl", "shader/blue_frag.glsl");
    Shader yellowShader("shader/obj_vert.glsl", "shader/yellow_frag.glsl");
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        Shader *objShader = &whiteShader;
        for (unsigned int i = 0; i != shapes.size(); i++) {
            if (i % 5 == 0) {
                objShader = &whiteShader;
            } else if (i % 5 == 1) {
                objShader = &redShader;
            } else if (i % 5 == 2) {
                objShader = &greenShader;
            } else if (i % 5 == 3) {
                objShader = &blueShader;
            } else if (i % 5 == 4) {
                objShader = &yellowShader;
            }
